<section class="menu" id="menu">
    <h1 class="heading"> Available <span>City Apartment</span></h1>
    ...
    <div class="box-container">
        ...
        $titleKeyword = "%Apartment%";
        $titleKeyword = "%Modern%";
        $titleKeyword = "%Penthouse%";
        $titleKeyword = "%Loft%";
        $titleKeyword = "%Urban%";
        $descriptionKeyword = "%urban%";
        $descriptionKeyword = "%modern%";
        $descriptionKeyword = "%city%";
