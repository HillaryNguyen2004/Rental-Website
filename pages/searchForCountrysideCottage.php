<section class="menu" id="menu">
    <h1 class="heading"> Available <span>Countryside Cottage</span></h1>
    ...
    <div class="box-container">
        ...
        $titleKeyword = "%Garden%";
        $titleKeyword = "%Cottage%";
        $titleKeyword = "%Farmhouse%";
        $descriptionKeyword = "%cozy%";
        // $descriptionKeyword = "%charming%";
